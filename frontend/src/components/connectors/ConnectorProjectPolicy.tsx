...
export function ConnectorProjectPolicy({ connectorId, readOnly }: { connectorId: string; readOnly: boolean }) {
  ...
  return <section className="prism-card" aria-labelledby="connector-capabilities-title">
    <header className="prism-card-header"><div className="prism-card-title-wrap"><div className="prism-card-icon"><Layers size={16} /></div><div><h2 id="connector-capabilities-title" className="prism-card-title">Project capabilities</h2><p className="prism-card-desc">Availability for every connection of this connector in the current project. Changes apply immediately.</p></div></div></header>
